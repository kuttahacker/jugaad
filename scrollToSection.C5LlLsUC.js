...
const fe = "http://www.w3.org/2000/svg"
  ...
  , pe = {
    ...
    createElement: (t, e, n, s) => {
        ...
        return t === "select" && s && s.multiple != null && o.setAttribute("multiple", s.multiple),
        o
    }
    ,
...
function Tt(t) {
    ...
    if (t.css === !1)
        return e;
    const {name: n="v", type: s, duration: o, enterFromClass: r=`${n}-enter-from`, enterActiveClass: a=`${n}-enter-active`, enterToClass: i=`${n}-enter-to`, appearFromClass: f=r, appearActiveClass: c=a, appearToClass: u=i, leaveFromClass: p=`${n}-leave-from`, leaveActiveClass: d=`${n}-leave-active`, leaveToClass: T=`${n}-leave-to`} = t
      , E = me(o)
      , It = E && E[0]
      , Ot = E && E[1]
      , {onBeforeEnter: q, onEnter: G, onEnterCancelled: U, onLeave: W, onLeaveCancelled: Dt, onBeforeAppear: Rt=q, onAppear: Bt=G, onAppearCancelled: Kt=U} = e
      , O = (l, m, v) => {
        C(l, m ? u : i),
        C(l, m ? c : a),
        v && v()
...
function nt(t, e, n, s) {
    ...
    const {type: a, timeout: i, propCount: f} = Et(t, e);
    if (!a)
        return s();
    const c = a + "end";
    let u = 0;
...
function Et(t, e) {
    ...
    e === g ? a > 0 && (u = g,
    p = a,
    d = r.length) : e === A ? c > 0 && (u = A,
    p = c,
    d = f.length) : (p = Math.max(a, c),
    u = p > 0 ? a > c ? g : A : null,
...
const L = Symbol("_vod")
  , Ge = {
    beforeMount(t, {value: e}, {transition: n}) {
        t[L] = t.style.display === "none" ? "" : t.style.display,
    ...
    updated(t, {value: e, oldValue: n}, {transition: s}) {
        !e == !n && t.style.display === t[L] || (s ? e ? (s.beforeEnter(t),
        N(t, !0),
        s.enter(t)) : s.leave(t, () => {
            N(t, !1)
        }
...
function be(t, e, n, s, o) {
    if (s && e.startsWith("xlink:"))
        n == null ? t.removeAttributeNS(at, e.slice(6, e.length)) : t.setAttributeNS(at, e, n);
    else {
        const r = te(e);
...
const ft = t => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && t.charCodeAt(2) > 96 && t.charCodeAt(2) < 123
  , _e = (t, e, n, s, o, r, a, i, f) => {
    const c = o === "svg";
    e === "class" ? ge(t, s, c) : e === "style" ? Se(t, n, s) : Jt(e) ? Qt(e) || ye(t, e, n, s, a) : (e[0] === "." ? (e = e.slice(1),
    !0) : e[0] === "^" ? (e = e.slice(1),
    !1) : Pe(t, e, s, c)) ? Te(t, e, s, r, a, i, f) : (e === "true-value" ? t._trueValue = s : e === "false-value" && (t._falseValue = s),
    be(t, e, s, c))
}
;
function Pe(t, e, n, s) {
    if (s)
        return !!(e === "innerHTML" || e === "textContent" || e in t && ft(e) && ht(n));
        ...
        () => {
            ...
            if (o)
                for (let c = 0; c < o.length; c++) {
                    const u = o[c];
                    Q(u, Z(u, i, s, n)),
                    At.set(u, u.el.getBoundingClientRect())
                }
            return re(f, null, r)
        }
    }
...
function De(t) {
    ...
    if (s || o) {
        const r = t.el.style;
        return r.transform = r.webkitTransform = `translate(${s}px,${o}px)`,
...
const K = Symbol("_assign")
  , je = {
    created(t, {modifiers: {lazy: e, trim: n, number: s}}, o) {
        ...
        e || (y(t, "compositionstart", Be),
        y(t, "compositionend", dt),
        y(t, "change", dt))
    },
    mounted(t, {value: e}) {
        t.value = e ?? ""
    },
    beforeUpdate(t, {value: e, modifiers: {lazy: n, trim: s, number: o}}, r) {
        if (t[K] = pt(r),
        t.composing)
            return;
...
const Ze = ({linkToSection: t, isInstant: e=!1, isPreviewMode: n=!1}) => {
    const s = document.getElementById(t.replace("#", ""));
    if (!s)
        return;
    const {offsetTop: o} = s
      , r = document.querySelector(`.${ae}`)?.offsetHeight || 0
      , a = document.querySelector(`.${ce}`)
      , i = document.querySelector(`.${le}`)
      , f = a ? o - r : o
      , c = e ? "instant" : "smooth";
...
;
export {vt as T, Xe as a, je as b, We as c, Qe as d, Je as e, Ye as r, Ze as s, Ue as u, Ge as v, ze as w};
